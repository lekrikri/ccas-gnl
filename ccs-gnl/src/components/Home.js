...
import { ReactComponent as DnlLogo } from '../assets/icon/gnlLogo.svg';
import '../App.css';
    ...
    const drawer = (
        ...
        <div className={classes.sidedrawer} height="100%">
            <div className={classes.toolbar} height="240px">
                <div className={classes.logo} height="70px">
                <DnlLogo className="gnl-logo" />
                </div></div>
            <List >
                ...
                <ListItem button style={{ padding: 6 }} >
                    <ListItemText primary="Recherche Générale" />
                ...
                <Divider style={{ backgroundColor: "grey" }} />
                <ListItem button style={{ padding: 6 }}>
                    <ListItemText primary="Sélections" />
                    <ListItemIcon className={classes.arrow}>
                        <ChevronRightOutlinedIcon />
                    </ListItemIcon>
                </ListItem>
                <Divider style={{ backgroundColor: "grey" }} />
                <ListItem button style={{ padding: 6 }}>
                    <ListItemText primary="Mon groupe de lecture (prêts, avis)" />
                    <ListItemIcon className={classes.arrow}>
                        <ChevronRightOutlinedIcon />
                    </ListItemIcon>
                </ListItem>
                ...
                <ListItemIcon>
                    ...
                    <ListItemText primary="Gestion des Éditeurs" />
                    <ListItemIcon className={classes.arrow}>
                        <ChevronRightOutlinedIcon />
                    </ListItemIcon>
                </ListItem>
                <Divider style={{ backgroundColor: "grey" }} />
                <ListItem button style={{ padding: 6 }}>
                    <ListItemText primary="Gestion des Genres" />
                    <ListItemIcon className={classes.arrow}>
                        <ChevronRightOutlinedIcon />
                    </ListItemIcon>
                </ListItem>
                <Divider style={{ backgroundColor: "grey" }} />
                <ListItem button style={{ padding: 6 }}>
                    <ListItemText primary="Gestion des Droits d'Accès" />
                    <ListItemIcon className={classes.arrow}>
                        <ChevronRightOutlinedIcon />
                    </ListItemIcon>
                </ListItem>
